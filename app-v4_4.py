...
def load_train_module():
    ...
    spec = importlib.util.spec_from_file_location("train_script_v4_4_lightning", module_path)
...
def build_ui() -> gr.Blocks:
    with gr.Blocks(title="Thonk v4.4 Generator") as demo:
        gr.Markdown("## Thonk v4.4 Text Generator")
        prompt = gr.Textbox(
            label="Prompt",
            lines=6,
